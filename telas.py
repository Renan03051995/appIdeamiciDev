...
class PaginaRgcpfPage(Screen):
    pass


class PaginaCarteirinhaePage(Screen):
    pass


class PaginaInfoMedicasPage(Screen):
    pass


class PaginaAvisosImportantesPage(Screen):
    pass
